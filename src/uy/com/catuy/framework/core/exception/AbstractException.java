...
/**
 * Excepcion abstracta que sirve como base para todas las excepciones checked manejadas por el Framework.
 *
 ...
 */
public abstract class AbstractException extends NestedCheckedException {

	/**
	 * UID para la serializacion.
	 */
	private static final long serialVersionUID = -5027102201454938785L;
	...
	/**
	 * Constructor para la clase AbstractException.
	 *
	 ...
	 */
	public AbstractException(String modulo, int idMensaje) {
	 ...
	 * @param cause causa de la excepcion
	 */
	public AbstractException(String modulo, int idMensaje, Throwable cause) {
	 ...
	 */
	public AbstractException(String modulo, int idMensaje, List<String> parametros) {
		super(modulo + SEPARADOR_MENSAJE + idMensaje);
	 ...
	 * @param cause causa de la excepcion
	 */
	public AbstractException(String modulo, int idMensaje, List<String> parametros, Throwable cause) {
		super(modulo + SEPARADOR_MENSAJE + idMensaje, cause);
	...
	private String cargarParametros(String plantilla, List<String> parametros) {
		...
		return StringUtils.replaceEach(plantilla, paramNombres, paramValores);
	}
